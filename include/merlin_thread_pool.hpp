#ifndef MERLIN_THREAD_POOL_HPP
#define MERLIN_THREAD_POOL_HPP

/*!
 * \file merlin_thread_pool.hpp
...
namespace merl
{
    ...
    class thread_pool final
    {
        ...
        public:
             ...
             */
            thread_pool(std::size_t threads_count = std::thread::hardware_concurrency());
            ~thread_pool();
